import { template, use, setStyleProperty, insert, memo, createComponent, Portal, mergeProps, effect, className, style, spread, setAttribute } from 'solid-js/web';
import { ComponentUtil, GridCoreCreator, CtrlsService, ColumnApi, BaseComponentWrapper, VanillaFrameworkOverrides, GridCtrl, GroupCellRendererCtrl, GridBodyCtrl, RowContainerName, TabGuardCtrl, TabGuardClassNames, _, GridHeaderCtrl, getRowContainerTypeForName, RowContainerCtrl, HeaderRowContainerCtrl, CssClassManager, HeaderRowType, AgPromise, PopupEditorWrapper } from 'ag-grid-community';
import { createContext, createSignal, onCleanup, onMount, createEffect, For, createMemo, on, useContext } from 'solid-js';
...
var memoObj = (obj) => {
  const keys = createMemo(() => Object.keys(obj), void 0, {
    equals: compareList
  });
  return createMemo(on(keys, (list) => {
    const out = {};
  ...
  return (() => {
    ...
    insert(_el$, (() => {
      ...
      return () => _c$() && createComponent(userComp_default, {
        ...
        ref(r$) {
          var _ref$3 = userCompRef;
          typeof _ref$3 === "function" ? _ref$3(r$) : userCompRef = r$;
        }
      });
    })(), _el$2);
    var _ref$2 = eResize;
...
var GridBodyComp = () => {
  ...
  return (() => {
    ...
    effect((_p$) => {
      var _v$ = getRootClasses(), _v$2 = getAriaColCount(), _v$3 = getAriaRowCount(), _v$4 = getTopClasses(), _v$5 = getTopStyle(), _v$6 = getBodyClasses(), _v$7 = getBodyViewportClasses(), _v$8 = getBodyViewportStyle(), _v$9 = getStickyTopClasses(), _v$0 = getStickyTopStyle(), _v$1 = getBottomClasses(), _v$10 = getBottomStyle();
      _v$ !== _p$.e && className(_el$, _p$.e = _v$);
      ...
      _p$.d = style(_el$5, _v$0, _p$.d);
      _v$1 !== _p$.l && className(_el$6, _p$.l = _v$1);
      _p$.u = style(_el$6, _v$10, _p$.u);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
var AgGridSolid = function(props) {
  ...
  return (() => {
    ...
    var _ref$ = eGui;
    typeof _ref$ === "function" ? use(_ref$, _el$) : eGui = _el$;
    setStyleProperty(_el$, "height", "100%");
    insert(_el$, (() => {
      var _c$ = memo(() => !!context());

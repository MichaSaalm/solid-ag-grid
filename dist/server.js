import { ssr, ssrStyleProperty, escape, createComponent, Portal, mergeProps, ssrAttribute, ssrStyle, ssrElement } from 'solid-js/web';
...
var AgGridSolid = function(props) {
  ...
  return ssr(_tmpl$17, ssrStyleProperty("height:", "100%"), context() && escape(createComponent(gridComp_default, {
    get ["class"]() {
      return props.class;
    },
    get context() {
